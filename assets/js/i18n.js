...
window.I18N = {
  en: {
    ...
    "band.1": "Brasserie",
    "band.2": "Terrace",
    "band.3": "All-day service",
    "band.4": "From the first coffee to the last glass",
    "band.5": "47 rue d'Amsterdam",
    "band.6": "Open 7 days a week",
    "hero.eyebrow": "Bar · Brasserie · Restaurant",
    "hero.lead": "From the first coffee to the last glass, every day.",
    "quick.menu": "Menu",
    "quick.call": "Call",
    ...
    "maison.title": "A zinc bar, a terrace, and the whole neighbourhood around it.",
    ...
    "vins.title": "Wine",
    "vins.more": "See the full wine list",
    ...
    "map.show": "Show map",
    "map.note": "The map is provided by Google Maps, which sets its own cookies.",
    ...
    "e404.title": "This table doesn't exist.",
    "e404.text": "The page you're looking for may have moved. Don't worry, there's still room on the terrace.",
